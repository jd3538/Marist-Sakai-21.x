...
public class BucketAllocation {
	 ...
	 */
	public BucketAllocation(String iBucketID, String iBucketType, int iMinimum, int iPersistence, boolean iReducible, int iRequested, int iAllocationStatus,
	        String iSCOID) {
		mBucketID = iBucketID;
    ...
    public int hashCode() {
	    ...
	    result = prime * result + ((mBucketType == null) ? 0 : mBucketType.hashCode());
	    result = prime * result + mMinimumSizeInt;
	    result = prime * result + mPersistence;
	    result = prime * result + (mReduciblebool ? 1231 : 1237);
	    result = prime * result + mRequestedSizeInt;
	    return result;
    }
