...
public class Messages {
	 ...
	 */
	private static final String BUNDLE_NAME = "org.adl.util.messages";
	...
	public static String getString(String iKey, String iParam1, int iParam2) {
		try {
			...
			message = message.replaceAll("p1", (iParam1 != null) ? iParam1 : "");
			message = message.replaceAll("p2", (replace != null) ? replace : "");
			return message;
		} catch (MissingResourceException e) {
			return '!' + iKey + '!';
		}
	...
	public static String getString(String iKey, String iParam1, String iParam2) {
		try {
			...
			message = message.replaceAll("p2", (iParam2 != null) ? iParam2 : "");
			return message;
		} catch (MissingResourceException e) {
			return '!' + iKey + '!';
		}
	 ...
	 * @return The message associated with the key.
	 */
	public static String getString(String iKey, String iParam1, String iParam2, String iParam3) {
		try {
			String message = RESOURCE_BUNDLE.getString(iKey);
			iParam1 = mkRegxReady(iParam1);
			iParam2 = mkRegxReady(iParam2);
			...
			message = message.replaceAll("p1", (iParam1 != null) ? iParam1 : "");
			message = message.replaceAll("p2", (iParam2 != null) ? iParam2 : "");
			message = message.replaceAll("p3", (iParam3 != null) ? iParam3 : "");
			return message;
		} catch (MissingResourceException e) {
			return '!' + iKey + '!';
		}
	...
	private static String replace(String ioString, String iOld, String iNew) {
		...
		while ((indexPos = ioString.indexOf(iOld, startPos)) != -1) {
			tempString = ioString.substring(0, indexPos) + iNew + ioString.substring(indexPos + iOld.length());
